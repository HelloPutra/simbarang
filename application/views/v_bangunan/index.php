        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="<?= base_url('bangunan/tambah');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Tambah Data</a>
                        <br><br>
                            ...
                            <tbody>
                                <?php $no=1; foreach ($data as $r) { ?>
                                    <tr>
                                        ...
                                        <td><?= $r->keterangan ?></td>    
                                        <td>
                                            <a href="<?= base_url('bangunan/edit/').$r->id_bangunan; ?>" class="btn btn-primary"><span class="fa fa-edit"></span> Edit</a>
